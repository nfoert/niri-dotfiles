...
if [ "$DISTRO" = "arch" ]; then
    ...
    echo -e "${YELLOW}${BOLD}swaylock-effects${NC}${YELLOW}, ${NC}${YELLOW}${BOLD}anyrun${NC}${YELLOW} and ${YELLOW}${BOLD}syshud${NC}${YELLOW} will need to be installed from the AUR using something like ${GRAY}yay -S swaylock-effects anyrun syshud${NC}"
